...
const Hamburger: React.FC<IHamburgerProps> = ({
  ...
  return (
    ...
    >
      <span
        className={`absolute top-0 left-0 block h-2 rounded-2 bg-orange100 opacity-100 transition-all duration-250 ease-in-out transform ${
          isMenuVisible ? "top-18 left-1/2 w-0" : "rotate-0 w-full"
        }`}
      />
      <span
        className={`absolute top-8 left-0 block h-2 w-full rounded-2 bg-orange100 opacity-100 transition-all duration-250 ease-in-out transform ${
      ...
      />
      <span
        className={`absolute top-16 left-0 block h-2 rounded-2 bg-orange100 opacity-100 transition-all duration-250 ease-in-out transform ${
